	...
	public static class MyConnection{
		public static  Connection getConnection(){
	        ...
	        try {
	            ...
	            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/onlinebookstore","root","1234");
	...
	public home() {
		...
		addWindowListener(new WindowAdapter() {
			...
			public void windowOpened(WindowEvent e) {
		        ...
		        String s1="select bname,author from book where bname='book-1'";
		        String s2="select bname,author from book where bname='book-2'";
		        String s3="select bname,author from book where bname='book-3'";
		        try {
		        	
		        	  
					
		        	
			    	p1= MyConnection.getConnection().createStatement();
					r1=p1.executeQuery(s1);
					
					if(r1.next()) {
						
						sresult.setText(r1.getString("bname"));
				    	author1.setText(r1.getString("author"));
					}
					p2= MyConnection.getConnection().createStatement();
					r2=p2.executeQuery(s2);
					
					if(r2.next()) {
						
						sresult1.setText(r2.getString("bname"));
				    	author2.setText(r2.getString("author"));
					}
					p3= MyConnection.getConnection().createStatement();
					r3=p3.executeQuery(s3);
					
					if(r3.next()) {
						
						sresult2.setText(r3.getString("bname"));
				    	author3.setText(r3.getString("author"));
					}
		...
		lblNewLabel.setBounds(34, 0, 200, 48);
